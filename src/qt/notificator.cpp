...
if( MacNotificationHandler::instance()->hasUserNotificationCenterSupport()) {
        ...
        CFSTR("com.Growl.GrowlHelperApp"), kCFCompareCaseInsensitive | kCFCompareBackwards) == kCFCompareEqualTo) {
...
void Notificator::notifyGrowl(Class cls, const QString &title, const QString &text, const QIcon &icon)
{
    ...
    QString growlApp(this->mode == Notificator::Growl13 ? "Growl" : "GrowlHelperApp");
        ...
        void Notificator::notifyMacUserNotificationCenter(Class cls, const QString &title,
        const QString &text, const QIcon &icon) {
            // icon is not supported by the user notification center yet. OSX will use the app
